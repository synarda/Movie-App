...
class AuthService {
  static Future<String?> getToken() async {
    final response = await http.get(
        Uri.http("api.themoviedb.org", "/3/authentication/token/new", {"api_key": "9c829acfb2666008b8b6304b45fc15a7"}),
        headers: {
  ...
  static Future<String?> postSession(String token) async {
    final response = await http.post(
        Uri.http(
            "api.themoviedb.org", "/3/authentication/session/new", {"api_key": "9c829acfb2666008b8b6304b45fc15a7"}),
        headers: {
          'Accept': 'application/json',
        },
        body: {
